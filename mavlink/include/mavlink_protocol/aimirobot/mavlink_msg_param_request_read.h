...
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC 255
#define MAVLINK_MSG_ID_20_CRC 255
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_param_request_read_t, target_system) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 3, offsetof(mavlink_param_request_read_t, param_id) }, \
...
static inline uint16_t mavlink_msg_param_request_read_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, const char *param_id, int16_t param_index)
{
...
{
    return mavlink_msg_param_request_read_pack(system_id, component_id, msg, param_request_read->target_system, param_request_read->param_id, param_request_read->param_index);
}
...
{
    return mavlink_msg_param_request_read_pack_chan(system_id, component_id, chan, msg, param_request_read->target_system, param_request_read->param_id, param_request_read->param_index);
}
...
static inline void mavlink_msg_param_request_read_send(mavlink_channel_t chan, uint8_t target_system, const char *param_id, int16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN];
    _mav_put_int16_t(buf, 0, param_index);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_request_read_send(chan, param_request_read->target_system, param_request_read->param_id, param_request_read->param_index);
#else
 ...
 */
static inline void mavlink_msg_param_request_read_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, const char *param_id, int16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
