...
#define MAVLINK_MSG_ID_PARAM_SET_MIN_LEN 22
#define MAVLINK_MSG_ID_23_LEN 22
#define MAVLINK_MSG_ID_23_MIN_LEN 22

#define MAVLINK_MSG_ID_PARAM_SET_CRC 39
#define MAVLINK_MSG_ID_23_CRC 39
...
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_param_set_t, target_system) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 5, offsetof(mavlink_param_set_t, param_id) }, \
         { "param_value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_param_set_t, param_value) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_param_set_t, param_type) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
...
static inline uint16_t mavlink_msg_param_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_SET_LEN];
    _mav_put_float(buf, 0, param_value);
    _mav_put_uint8_t(buf, 4, target_system);
    _mav_put_uint8_t(buf, 21, param_type);
...
{
    return mavlink_msg_param_set_pack(system_id, component_id, msg, param_set->target_system, param_set->param_id, param_set->param_value, param_set->param_type);
}
...
{
    return mavlink_msg_param_set_pack_chan(system_id, component_id, chan, msg, param_set->target_system, param_set->param_id, param_set->param_value, param_set->param_type);
}
...
static inline void mavlink_msg_param_set_send(mavlink_channel_t chan, uint8_t target_system, const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_SET_LEN];
    _mav_put_float(buf, 0, param_value);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_set_send(chan, param_set->target_system, param_set->param_id, param_set->param_value, param_set->param_type);
#else
 ...
 */
static inline void mavlink_msg_param_set_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
