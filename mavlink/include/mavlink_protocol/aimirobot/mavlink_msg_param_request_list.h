...
#define MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN 1
#define MAVLINK_MSG_ID_PARAM_REQUEST_LIST_MIN_LEN 1
#define MAVLINK_MSG_ID_21_LEN 1
#define MAVLINK_MSG_ID_21_MIN_LEN 1

#define MAVLINK_MSG_ID_PARAM_REQUEST_LIST_CRC 253
#define MAVLINK_MSG_ID_21_CRC 253
...
{
    return mavlink_msg_param_request_list_pack(system_id, component_id, msg, param_request_list->target_system);
}
...
{
    return mavlink_msg_param_request_list_pack_chan(system_id, component_id, chan, msg, param_request_list->target_system);
}
...
static inline void mavlink_msg_param_request_list_send(mavlink_channel_t chan, uint8_t target_system)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_REQUEST_LIST_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_request_list_send(chan, param_request_list->target_system);
#else
 ...
 */
static inline void mavlink_msg_param_request_list_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
